...
protected boolean doAddAll(int index, IDoubleListable list) {
    ...
    private void doAddAllTail(IDoubleListable list, int addPos, int addLen, int space) {
    ...
    private void doAddAllHead(IDoubleListable list, int addPos, int addLen, int space) {
    assert (addPos == 0);
    for (int i = 0; i < space; i++) {
...
void doAddAllMiddle(IDoubleListable list, int addPos) {
...
private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
    ...
    static class DoubleBlock extends DoubleGapList {
