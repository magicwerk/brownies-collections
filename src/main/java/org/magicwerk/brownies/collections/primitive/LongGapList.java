...
/**
 * Class {link LongGapList} combines the strengths of both {@link ArrayList} and {@link LinkedList}.
...
public static LongGapList immutable(Collection<Long> coll) {
    LongGapList list = new LongGapList(coll.size());
    list.init(coll);
 ...
 */
@SafeVarargs
public static LongGapList immutable(long... elems) {
    LongGapList list = new LongGapList(elems.length);
    list.init(elems);
    return list.unmodifiableList();
}
