...
public class LongMergeSort {
	...
	public static <E> void sort(ILongList list) {
		LongMergeSort sort = new LongMergeSort(list);
		sort.sort();
	}
	...
	private LongMergeSort(ILongList list) {
		this.list = list;
	...
	private int compare(int idx1, int idx2) {
		long val1 = list.get(idx1);
		long val2 = list.get(idx2);
		return (val1<val2 ? -1 : (val1==val2 ? 0 : 1));
	}

	private void swap(int idx1, int idx2) {
		long val = list.get(idx1);
