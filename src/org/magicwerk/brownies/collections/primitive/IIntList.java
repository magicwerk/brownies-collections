 ...
 *
 * $Id: IIntList.java 3448 2017-01-31 07:46:38Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: IIntList.java 3448 2017-01-31 07:46:38Z origo $
 *
...
public Set getDistinct() {
     ...
     * @return			created list
     */
public <R> IList<R> mappedList(Function<Integer, R> mapper) {
    int size = size();
    ...
    public void map(UnaryOperator<Integer> operator) {
    int size = size();
    for (int i = 0; i < size; i++) {
        int e = doGet(i);
        e = operator.apply(e);
...
public boolean removeLastOccurrence(int elem) {
    ...
    // --- Static bulk transfer methods working with two IIntLists ---  
/**
