 ...
 *
 * $Id: IIntList.java 4520 2019-09-21 00:41:58Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: IIntList.java 4520 2019-09-21 00:41:58Z origo $
 *
...
public void transform(UnaryOperator<Integer> op) {
	 ...
	 * @return			created list
	 */
public IIntList filteredList(Predicate<Integer> predicate) {
    IIntList list = doCreate(-1);
    int size = size();
    for (int i = 0; i < size; i++) {
        int e = doGet(i);
...
public void filter(Predicate<Integer> predicate) {
    ...
    IIntList list = filteredList(predicate);
    doAssign(list);
}
