 ...
 *
 * $Id: IFloatList.java 2597 2014-11-18 17:10:54Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: IFloatList.java 2597 2014-11-18 17:10:54Z origo $
 *
...
public boolean removeLastOccurrence(float elem) {
    ...
    // --- Static bulk methods working with two IFloatLists ---  
/**
...
public void setAll(int index, Collection<Float> coll) {
     ...
     */
public void merge(int index, Collection<Float> coll) {
    checkIndexAdd(index);
    // In contrary to addAll() there is no need to first create an array   
    // containing the collection elements, as the list will not grow.   
    int size = size();
