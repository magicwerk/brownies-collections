 ...
 *
 * $Id: IFloatList.java 4083 2018-07-14 14:42:03Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: IFloatList.java 4083 2018-07-14 14:42:03Z origo $
 *
...
public Set getDistinct() {
     ...
     * @return			created list
     */
public <R> IList<R> mappedList(Function<Float, R> mapper) {
    int size = size();
    ...
    public void map(UnaryOperator<Float> operator) {
    int size = size();
    for (int i = 0; i < size; i++) {
        float e = doGet(i);
        e = operator.apply(e);
