 ...
 * speed. Use DoubleObjGapList to combine these features with the
 ...
 * @see	    org.magicwerk.brownies.collections.primitive.DoubleObjGapList
 */
...
public class DoubleGapList implements Cloneable, Serializable {
	...
	public static  DoubleGapList create(double... elems) {
		return new DoubleGapList(elems);
	}
...
return (int) val;
     ...
     */
    public DoubleGapList getAll(int index, int len) {
