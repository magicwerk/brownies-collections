 ...
 * speed. Use LongObjGapList to combine these features with the
 ...
 * @see	    org.magicwerk.brownies.collections.primitive.LongObjGapList
 */
...
public class LongGapList implements Cloneable, Serializable {
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected void initClone(LongGapList that) {
...
return (int) val;
    ...
    */
	...
	private void debugCheck() {
		// If the LongGapList is not used for storing content in KeyListImpl, values may be (long)0
		if (values == null) {
