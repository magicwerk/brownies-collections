...
public class LongGapList implements Cloneable, Serializable {
    ...
    private static LongGapList EMPTY = LongGapList.create().unmodifiableList();
	...
	public static  LongGapList create(Collection<Long> elements) {
		return new LongGapList(elements);
	}
	 ...
	 * @param  		type of elements stored in the list
	 */
	public static  LongGapList create(long... elements) {
		return new LongGapList(elements);
	}
     ...
     */
    LongGapList(boolean copy, LongGapList that) {
        if (copy) {
...
return (int) val;
     ...
     */
    public LongGapList get(int index, int len) {
