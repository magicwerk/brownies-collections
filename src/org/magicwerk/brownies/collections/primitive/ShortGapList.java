 ...
 */
public class ShortGapList extends IShortGapList {
...
public ShortGapList unmodifiableList() {
    ...
    @Override
protected void initClone(IShortGapList that) {
...
public int size() {
	 ...
	 * Note that two ShortGapLists are considered equal even if they have a distinct capacity.
...
private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
    ...
    @Override
public IShortGapList doCreate(int capacity) {
    if (capacity == -1) {
