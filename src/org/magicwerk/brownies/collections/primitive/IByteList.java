 ...
 *
 * $Id: IByteList.java 2518 2014-10-16 23:31:40Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: IByteList.java 2518 2014-10-16 23:31:40Z origo $
 *
...
public Set getDistinct() {
     ...
     * @return			created list
     */
public <R> IList<R> mappedList(Mapper<Byte, R> mapper) {
    int size = size();
