 ...
 *
 * $Id: ByteBigList.java 2581 2014-11-11 00:49:14Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: ByteBigList.java 2581 2014-11-11 00:49:14Z origo $
 */
    ...
    if (addLen <= space) {
        ...
        if (index == size) {
            ...
            while (todo > 0) {
                ...
                for (int i = 0; i < add; i++) {
                    nextByteBlock.add(i, array[done + i]);
                }
                done += add;
                todo -= add;
            ...
            while (todo > 0) {
                ...
                int add = Math.min(todo, blockSize);
                for (int i = 0; i < add; i++) {
                    nextByteBlock.add(i, array[addLen - done - add + i]);
                }
                done += add;
                todo -= add;
