 ...
 *
 * $Id: FloatBigList.java 3408 2016-12-06 00:20:45Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: FloatBigList.java 3408 2016-12-06 00:20:45Z origo $
 */
    ...
    if (addLen <= space) {
        ...
        if (index == size) {
            ...
            if (has < should) {
                ...
                if (sublist.size() != add) {
                    IFloatList sublist2 = list2.getAll(0, add);
                }
                listPos += add;
