 ...
 * speed. Use FloatObjGapList to combine these features with the
 ...
 * @see	    org.magicwerk.brownies.collections.primitive.FloatObjGapList
 */
...
public class FloatGapList implements Cloneable, Serializable {
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected void initClone(FloatGapList that) {
...
return (int) val;
    ...
    */
	...
	private void debugCheck() {
		// If the FloatGapList is not used for storing content in KeyListImpl, values may be (float)0
		if (values == null) {
