 ...
 *
 * $Id: ILongList.java 3834 2018-02-12 20:18:06Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: ILongList.java 3834 2018-02-12 20:18:06Z origo $
 *
...
public Set getDistinct() {
     ...
     * @return			created list
     */
public <R> IList<R> mappedList(Function<Long, R> mapper) {
    int size = size();
    ...
    public void map(UnaryOperator<Long> operator) {
    int size = size();
    for (int i = 0; i < size; i++) {
        long e = doGet(i);
        e = operator.apply(e);
