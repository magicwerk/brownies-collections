 ...
 *
 * $Id: ILongList.java 2579 2014-11-10 06:35:42Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: ILongList.java 2579 2014-11-10 06:35:42Z origo $
 *
...
public boolean removeLastOccurrence(long elem) {
    ...
    // --- Static bulk methods working with two ILongLists ---  
/**
...
public void setAll(int index, Collection<Long> coll) {
     ...
     */
public void merge(int index, Collection<Long> coll) {
    checkIndexAdd(index);
    // In contrary to addAll() there is no need to first create an array   
    // containing the collection elements, as the list will not grow.   
    int size = size();
