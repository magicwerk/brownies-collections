    ...
    if (addLen <= space) {
        ...
        if (index == size) {
            ...
            for (int i = 0; i < space; i++) {
                currDoubleBlock.values.add(addPos, array[i]);
            }
            ...
            currNode = currNode.next();
            currDoubleBlock = currNode.block;
            currDoubleBlockStart = currDoubleBlockEnd + space;
            currDoubleBlockEnd = currDoubleBlockStart + addLen - space;
        } else if (index == 0) {
            // Add elements at head   
            assert (addPos == 0);
            for (int i = 0; i < space; i++) {
                currDoubleBlock.values.add(addPos, array[addLen - space + i]);
            }
            modify(currNode, space);
            int done = space;
            int todo = addLen - space;
            ...
            currDoubleBlock = currNode.block;
            currDoubleBlockStart = 0;
            currDoubleBlockEnd = addLen - space;
        } else {
