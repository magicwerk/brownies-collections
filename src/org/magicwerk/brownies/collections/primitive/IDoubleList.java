 ...
 *
 * $Id: IDoubleList.java 4083 2018-07-14 14:42:03Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: IDoubleList.java 4083 2018-07-14 14:42:03Z origo $
 *
...
public Set getDistinct() {
     ...
     * @return			created list
     */
public <R> IList<R> mappedList(Function<Double, R> mapper) {
    int size = size();
