 ...
 *
 * $Id: IDoubleList.java 2714 2015-01-29 01:06:52Z origo $
 */
 ...
 *
 * @author Thomas Mauch
 * @version $Id: IDoubleList.java 2714 2015-01-29 01:06:52Z origo $
 *
...
protected boolean doAddAll(int index, double[] array) {
    ...
    public boolean addMult(int num, double elem) {
    return doAddMult(-1, num, elem);
}

    public boolean addMult(int index, int num, double elem) {
    return doAddMult(index, num, elem);
}

    protected boolean doAddMult(int index, int num, double elem) {
    checkLength(num);
    if (num == 0) {
        return false;
    }
...
public void setArray(int index, double... elems) {
     ...
     * @throws 		IndexOutOfBoundsException if the range is invalid
     */
public void setMult(int index, int num, double elem) {
