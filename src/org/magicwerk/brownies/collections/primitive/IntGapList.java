 ...
 * speed. Use IntObjGapList to combine these features with the
 ...
 * @see	    org.magicwerk.brownies.collections.primitive.IntObjGapList
 */
...
public class IntGapList implements Cloneable, Serializable {
	 ...
	 */
	protected void initClone(IntGapList that) {
...
return (int) val;
    ...
    */
	...
	private void debugCheck() {
		// If the IntGapList is not used for storing content in KeyListImpl, values may be (int)0
		if (values == null) {
