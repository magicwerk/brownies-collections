 ...
 */
public class IntGapList extends IIntGapList {
...
public IntGapList unmodifiableList() {
    ...
    @Override
protected void initClone(IIntGapList that) {
...
public int size() {
	 ...
	 * Note that two IntGapLists are considered equal even if they have a distinct capacity.
...
private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
    ...
    @Override
public IIntGapList doCreate(int capacity) {
    if (capacity == -1) {
