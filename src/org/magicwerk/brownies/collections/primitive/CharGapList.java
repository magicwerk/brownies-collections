 ...
 * speed. Use CharObjGapList to combine these features with the
 ...
 * @see	    org.magicwerk.brownies.collections.primitive.CharObjGapList
 */
...
public class CharGapList implements Cloneable, Serializable {
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected void initClone(CharGapList that) {
