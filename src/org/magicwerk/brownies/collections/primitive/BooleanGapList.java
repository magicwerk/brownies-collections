 ...
 * speed. Use BooleanObjGapList to combine these features with the
 ...
 * @see	    org.magicwerk.brownies.collections.primitive.BooleanObjGapList
 */
...
public class BooleanGapList implements Cloneable, Serializable {
	 ...
	 */
	public BooleanGapList(Collection<Boolean> coll) {
		init(coll);
	}
	 ...
	 * @param elems	array with elements
	 */
	public BooleanGapList(boolean... elems) {
		init(elems);
	}
