...
public class GapSet<E> implements NavigableSet<E> {
    ...
    private GapSet(Comparator<? super E> comparator) {
        ...
        //this.list = new GapList<E>(false, null); TODO
    }
    ...
    private GapSet<E> init(Collection<? extends E> elements) {
        list.initAll(elements);
        return this;
    }

    private GapSet<E> init(E... elements) {
        list.initArray(elements);
        return this;
    }
	...
	public NavigableSet<E> subSet(E fromElement, boolean fromInclusive, E toElement, boolean toInclusive) {
		...
		//return new GapSet<E>(comparator, list.getAll(fromIndex, toIndex-fromIndex)).unmodifiableSet();
        return null; // FIXME
	}
