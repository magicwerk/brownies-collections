 ...
 * <p>
 * Copyright (c) 2006 Melloware, Inc. {@literal <http://www.melloware.com> }
 * @author Emil A. Lefkof III {@literal <elefkof@ksmpartners.com> }
 * @version 1.0
 */
public class JIntellitypeTester extends JFrame implements HotkeyListener, IntellitypeListener {
	...
	*/
	private void btnRegisterHotKey_actionPerformed(ActionEvent aEvent) {
		...
		JIntellitype.getInstance().registerHotKey(F11, "F1");
