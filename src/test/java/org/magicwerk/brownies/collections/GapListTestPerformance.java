...
import org.magicwerk.brownies.test.jvm.JavaEnvironment;
import org.magicwerk.brownies.test.jvm.JmhRunner;
import org.magicwerk.brownies.test.jvm.JavaEnvironment.JavaVersion;
import org.magicwerk.brownies.test.jvm.JmhRunner.Options;
...
public class GapListTestPerformance {
	...
	static class AllTestRuns {
		...
		void runTest(Consumer<TestRuns> run) {
			TestRuns tr = newRun();
			trs.add(tr);
			run.accept(tr);
		}
