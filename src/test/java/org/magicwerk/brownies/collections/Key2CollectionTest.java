...
public class Key2CollectionTest extends TestHelper {
    ...
    public static void testInvalidate() {
        Key2Collection<Ticket,Integer,String> coll = new Key2Collection.Builder<Ticket,Integer,String>().
        		withKey1Map(Ticket.IdMapper).withKey1Duplicates(false).withKey1Sort(true).
        		withKey2Map(Ticket.ExtIdMapper).withKey2Duplicates(true).withKey2Sort(true).build();
        Ticket t1 = new Ticket(1, "extId1", "text1");
    ...
    public static void testKey2Collection() {
        Key2Collection<Ticket,Integer,String> coll = new Key2Collection.Builder<Ticket,Integer,String>().
        		withKey1Map(Ticket.IdMapper).withKey1Null(false).withKey1Duplicates(false).
        		withKey2Map(Ticket.ExtIdMapper).withKey2Duplicates(false, true).build();
        Ticket t1 = new Ticket(1, "extId1", "text1");
    ...
    public static void testIterator() {
        ...
        Key2Collection<Ticket,Integer,String> coll1 = new Key2Collection.Builder<Ticket,Integer,String>().
        		withElemSet().withOrderByElem(true).withKey1Map(Ticket.IdMapper).withKey2Map(Ticket.ExtIdMapper).build();
        coll1.add(t1);
        coll1.add(t2);
        coll1.add(t3);
        coll1.add(t4);
        ...
        Key2Collection<Ticket,Integer,String> coll2 = new Key2Collection.Builder<Ticket,Integer,String>().
    ...
    public static void testCloneCopyCrop() {
        Key2Collection<Ticket,Integer,String> tickets = new Key2Collection.Builder<Ticket,Integer,String>().
        		withNull(false).withConstraint(Ticket.Constraint).
        		withPrimaryKey1Map(Ticket.IdMapper).withOrderByKey1(true).
...
//        Assert.assertTrue(tickets2.equals(tickets));
    ...
    public static void testBiMap() {
        ...
        Key2Collection<BiEntry, Integer, String> biMap =
        		new Key2Collection.Builder<BiEntry, Integer, String>().
        		withKey1Map(mapper1).withKey1Sort(true).
