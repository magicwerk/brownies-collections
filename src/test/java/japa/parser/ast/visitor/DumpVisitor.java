...
//
// CHANGE:
// The only changes made to the original are to change some modifier
// so the behavior can be changed through inheritance.
// (Note that creating a delegate will not work)
//
// CHANGE: public final class DumpVisitor implements VoidVisitor<Object> {
public class DumpVisitor implements VoidVisitor<Object> {

//	CHANGE: private static class SourcePrinter {
...
//	CHANGE: private final SourcePrinter printer = new SourcePrinter();
...
//	CHANGED: private void printModifiers(final int modifiers) {
...
//	CHANGED: private void printMemberAnnotations(final List<AnnotationExpr> annotations, final Object arg) {
...
//	CHANGED: private void printAnnotations(final List<AnnotationExpr> annotations, final Object arg) {
...
//	CHANGED: private void printTypeParameters(final List<TypeParameter> args, final Object arg) {
...
//	CHANGED: private void printArguments(final List<Expression> args, final Object arg) {
...
//	CHANGE: private void printJavadoc(final JavadocComment javadoc, final Object arg) {
...
//	CHANGE: private void printJavaComment(final Comment javacomment, final Object arg) {
